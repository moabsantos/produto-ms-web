                ...
                <Routes>
                    <Route exact path='/' element={<PageBase />}>
                        <Route exact path='/' element={<PageHeader />}>
                            ...
                            <Route path='/cliente-estabelecimento/:idMaster' element={<ClienteEstabelecimento />} />
                            ...
                            <Route path='/deposito-inventario' element={<DepositoInventario />} />
                            <Route path='/deposito-inventario-item/:idMaster' element={<DepositoInventarioItem />} />
